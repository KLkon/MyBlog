        ...
        <div class="content_resize">
            <div class="mainbar">
                ...
                <p class="pages">
                    ...
                    <a href="/getPageBlog?pn=${pageInfo.firstPage}">首页</a>
                    </c:if>
                    <c:if test="${pageInfo.hasPreviousPage}">
                        <a href="/getPageBlog?pn=${pageInfo.prePage}">&laquo;</a>
                    </c:if>
                    <c:forEach var="page" items="${pageInfo.navigatepageNums}">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="/getPageBlog?pn=${page}">${page}</a>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    <c:if test="${pageInfo.hasNextPage}">
                        <a href="/getPageBlog?pn=${pageInfo.nextPage}">&raquo;</a>
                    </c:if>
                    <c:if test="${pageInfo.hasNextPage}">
                    <a href="/getPageBlog?pn=${pageInfo.pages}">末页</a>
                    </c:if>
                </p>
            </div>
